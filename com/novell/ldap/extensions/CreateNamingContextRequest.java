/* **************************************************************************
 * $Id: CreateNamingContextRequest.java,v 1.8 2000/08/08 16:58:41 javed Exp $
 *
...
/**
 *
 *      This class is used to create a new naming context. (NDS partition).
 ...
 *
 * @param dn:  Specify the distinguished name of the container
 *                  where the new naming context root should be located.<br><br>
 *
 * @param flags:  Specifies if all servers in the replica ring must be up before 
 * proceeding.  Set to LDAP_ENSURE_SERVERS_UP 
